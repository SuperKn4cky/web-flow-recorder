...
# Codex CLI >= 0.111 removed `--yolo`; use exec mode with `--full-auto`.
AGENT_CODEX_CMD="codex exec --full-auto --skip-git-repo-check -"
AGENT_CODEX_INTERACTIVE_CMD="codex exec --full-auto --skip-git-repo-check -"
